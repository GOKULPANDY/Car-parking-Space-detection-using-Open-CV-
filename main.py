...
fn = r"\Users\user\Documents\DetectParking-develop\datasets\parkinglot_1_480p.mp4"

fn_yaml = r"\Users\user\Documents\DetectParking-develop\datasets\parking2.yml"
fn_out = r"\Users\user\Documents\DetectParking-develop\datasets\output.avi"
...
while(cap.isOpened()):   
    ...
    cv2.imshow('vechile lot detection by team ALPHA', frame_out)
    cv2.waitKey(40)
